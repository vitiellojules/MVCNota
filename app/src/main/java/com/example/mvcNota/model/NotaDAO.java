...
public class NotaDAO {
    ...
    public Nota updateNota( Nota nota ){
        ...
        sqLiteDatabase.update("nota",contentValues,"id",new String[] {
                Integer.toString(nota.getId())
        });
       return nota;
    }
   public boolean deleteNota (Nota nota){

      sqLiteDatabase.delete("nota","id",new String[] {
              Integer.toString(nota.getId())
      });
